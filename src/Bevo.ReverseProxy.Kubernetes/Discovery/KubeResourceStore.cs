...
namespace Bevo.ReverseProxy.Kube
{
    public class KubeResourceStore : IKubeResourceStore, IDisposable
    {
        ...
        public KubeResourceStore(IKubernetes client, IEventRecorder eventRecorder, IConfigValidator configValidator, ILogger<KubeResourceStore> logger)
        {
        ...
        public async Task<BackendConfiguration> GetBackendConfiguration(IEnumerable<IngressModel> ingresses, CancellationToken cancellation)
        {
